            ...
            <form action="adminregister" method="post">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="street" aria-describedby="emailHelp" name="street" placeholder="EnterStreet.." required>
                 </div>
                 ...
                 <div class="form-group">
                    <label for="password">Password</label>
                    <input type="password" class="form-control" id="password" aria-describedby="emailHelp" name="password" placeholder="Enter password.." pattern="^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=_!])([a-zA-Z0-9@#$%^&+=_!]{8,20})$" required>
