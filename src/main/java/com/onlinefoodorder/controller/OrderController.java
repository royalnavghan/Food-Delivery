...
public class OrderController {
	...
	public ModelAndView orderfoods(HttpSession session) {
	    ...
	    mv.addObject("statusWithoutOrderId","Order placed Successfully");
...
//			orderDao.save(order);
//			cartDao.delete(cart);
//			logger.log(Level.INFO, "Order placed for food with ID: " + cart.getFoodId());
//		}
//	
//	    mv.addObject("status","Order placed Successfully, Order Id is "+orderId);
//	    mv.addObject("statusWithoutOrderId","Order placed Successfully");
...
//			order.setDeliveryStatus(deliveryStatus);
//		    this.orderDao.save(order);
//		    logger.log(Level.INFO, "Delivery status updated for order with ID: " + order.getOrderId());
//		}
//		
//		mv.addObject("status", "Order Delivery Status Updated.");
//		mv.setViewName("index");
