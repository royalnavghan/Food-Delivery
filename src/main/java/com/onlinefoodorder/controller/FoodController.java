...
public class FoodController {
	...
	public ModelAndView addProduct(HttpServletRequest request, HttpSession session) throws IOException, ServletException {
		...
		String uploadPath = "C:\\Users\\HP\\Documents\\hiii\\online-food-order\\src\\main\\webapp\\resources\\productpic\\"
				+ fileName;		
		try
		{
...
//				+ fileName;
//
//		try (FileOutputStream fos = new FileOutputStream(uploadPath); InputStream is = part.getInputStream()) {
//			byte[] data = new byte[is.available()];
//			is.read(data);
//			fos.write(data);
//		} catch (Exception e) {
//			logger.log(Level.SEVERE, "Failed to upload image for food", e);
//		}
//
//		Food food = new Food();
//		food.setCategoryId(categoryId);
...
//
//		if (food != null) {
//			logger.log(Level.INFO, "Food Added Successfully.");
//			mv.addObject("status", "Food Added Successfully.");
//		} else {
//			logger.log(Level.WARNING, "Failed to add food.");
//			mv.addObject("status", "Failed to add food.");
//		}
//
//		mv.setViewName("index");
...
//		String fileName = part.getSubmittedFileName();
//
////		String uploadPath = "C:\\Users\\HP\\Desktop\\online-food-order-master\\src\\main\\webapp\\resources\\productpic\\"
////				+ fileName;
//		String uploadPath = "C:\\Users\\HP\\Documents\\hiii\\online-food-order\\src\\main\\webapp\\resources\\productpic\\"
//				+ fileName;
//		try (FileOutputStream fos = new FileOutputStream(uploadPath); InputStream is = part.getInputStream()) {
...
//
//		if (food != null) {
//			logger.log(Level.INFO, "Food updated Successfully.");
//			mv.addObject("status", "Food updated Successfully.");
//		} else {
//			logger.log(Level.WARNING, "Failed to update food.");
//			mv.addObject("status", "Failed to update food.");
//		}
//
//		mv.setViewName("index");
...
//
//	@GetMapping("/searchfood")
//	public ModelAndView searchProductByName(@RequestParam("foodname") String foodName)
//			throws IOException, ServletException {
//		ModelAndView mv = new ModelAndView();
//		List<Food> foods = new ArrayList<>();
//		foods = foodDao.findByNameContainingIgnoreCase(foodName);
...
//		foodDao.delete(food);
//
//		logger.log(Level.INFO, "Food Deleted Successfully!");
//		mv.addObject("status", "Food Deleted Successfully!");
//		mv.setViewName("index");
//
//		return mv;
